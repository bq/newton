...
#define RT5631_ALC_DAC_FUNC_ENA 0	//ALC functio for DAC              //hjc  1-0 @12-02-04
...
#endif
#ifndef DEF_VOL_SPK
#define DEF_VOL_SPK				0xc6//0xc4 6db /0xc8 0db /0xca -3db
#endif
...
static struct rt5631_init_reg init_list[] = {
	...
	{RT5631_MONO_AXO_1_2_VOL	, 0xf0c0},//AXO1/AXO2 channel volume select OUTMIXER,0DB by default   0xf0c0
	//{RT5631_STEREO_DAC_VOL_1	, 0x004C},
	{RT5631_ADC_REC_MIXER		, 0xb0f0},//Record Mixer source from Mic1 by default
	{RT5631_ADC_CTRL_1		, 0x0003},//STEREO ADC CONTROL 1
	{RT5631_MIC_CTRL_2		, 0x3300},//0x8800},//0x5500}, //Mic1/Mic2 boost 40DB by default
	{RT5631_PWR_MANAG_ADD1		, 0x93e0},
	
	{RT5631_STEREO_DAC_VOL_2        , 0x0707},//add by hjc
