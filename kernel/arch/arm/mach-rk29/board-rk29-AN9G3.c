...
#define CONFIG_SENSOR_1 										RK29_CAM_SENSOR_GC0308//GT2005                      /* front camera sensor */
#define CONFIG_SENSOR_IIC_ADDR_1 	    				0x42//78
#define CONFIG_SENSOR_IIC_ADAPTER_ID_1    		1
#define CONFIG_SENSOR_ORIENTATION_1       		270
#define CONFIG_SENSOR_POWER_PIN_1         		INVALID_GPIO
#define CONFIG_SENSOR_RESET_PIN_1         		INVALID_GPIO
...
#define TOUCH_SCREEN_STANDBY_VALUE        GPIO_LOW
#define TOUCH_SCREEN_DISPLAY_PIN          INVALID_GPIO
#define TOUCH_SCREEN_DISPLAY_VALUE        GPIO_LOW
//added by liqing for this>>>>>>>>>>>>>>>>>>>>>>
...
//added by liqing for this>>>>>>>>>>>>>>>>>>>>>>
	 gpio_direction_output(FB_LCD_STANDBY_PIN, 0);
	 gpio_set_value(FB_LCD_STANDBY_PIN, GPIO_LOW);
//added by liqing for this>>>>>>>>>>>>>>>>>>>>>>
        }
...
//added by liqing for this>>>>>>>>>>>>>>>>>>>>>>
    ...
    gpio_set_value(RK29_PIN6_PD3,GPIO_HIGH);
//added by liqing for this>>>>>>>>>>>>>>>>>>>>>>
