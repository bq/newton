...
#endif
#endif
int screen_x[5] = {33,991,33,991,512};//{ 50, 750,  50, 750, 400};
int screen_y[5] = {27,27,573,573,300};//{ 50,  50, 550, 550, 300};
//int screen_x[5] = {50,974,50,974,512};//{ 50, 750,  50, 750, 400};
//int screen_y[5] = {40,40,560,560,300};//{ 50,  50, 550, 550, 300};
int uncali_x_default[5] = { 335,  3679, 341,  3684, 2183 };
int uncali_y_default[5] = { 3661,  3683, 349,  339, 2087 };
int uncali_x[5] = { 0 };
int uncali_y[5] = { 0 };
...
static ssize_t touch_adc_show(struct class *cls,struct class_attribute *attr, char *_buf)
{
	...
	if((gADPoint.x<150)&&(gADPoint.y<250)){
		gADPoint.x -= 15;
		gADPoint.y -= 15;
	}
	else if((gADPoint.x>850)&&(gADPoint.y<250)){
		gADPoint.x += 17;
		gADPoint.y -= 15;
	}
	else if((gADPoint.x<150)&&(gADPoint.y>800)){
		gADPoint.x -= 15;
		gADPoint.y += 15;
	}
	else if((gADPoint.x>850)&&(gADPoint.y>800)){
		gADPoint.x += 17;
		gADPoint.y += 15;
	}
	printk("hjc---ADC show: x=%d y=%d\n", gADPoint.x, gADPoint.y);
